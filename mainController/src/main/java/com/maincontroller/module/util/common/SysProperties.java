...
public class SysProperties {
    ...
    public static final String SEQUENCE_PATH_PROP_KEY="SEQUENCEPATH";
    public static final String SEQUENCE_PATH_KEY="path";
    public static final String APPID_PROP_KEY="APPID";
    public static final String APPID_KEY="appId";
    public static final String IMAGE_PROP_KEY="IMAGE";
    public static final String GOODSIMG_KEY="goodsImg";
